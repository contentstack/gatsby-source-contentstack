...
var _getSyncData = /*#__PURE__*/function () {
  var _ref8 = (0, _asyncToGenerator2["default"])(function (url, config, query, responseKey) {
    ...
    return /*#__PURE__*/_regenerator["default"].mark(function _callee8() {
      var response, timeToWait, aggregatedSyncToken, SyncRetryCount, _iterator, _step, _aggregatedResponse$d, _aggregatedResponse$d2, token, syncResponse, _timeToWait;
      return _regenerator["default"].wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          ...
          case 41:
            ...
            console.error("Got Error 2", _context8.t1);
            if (!(SyncRetryCount < config.httpRetries)) {
              _context8.next = 54;
              break;
            }
            _timeToWait = Math.pow(2, SyncRetryCount) * 100;
            SyncRetryCount++;
      ...
      }, _callee8, null, [[0, 71], [7, 13], [30, 61, 64, 67], [35, 41]]);
    })();
  });
